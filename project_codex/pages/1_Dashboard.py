...
st.header(I18N.get("upload_header"))
...
with col1:
    ...
    # Save to Session via Manager
    if uploaded_files:
        for f in uploaded_files:
            SessionManager.save_uploaded_file(f)
...
if st.button(I18N.get("start_btn")):
...
# --- Task Monitor ---
st.header(I18N.get("monitor_header"))
